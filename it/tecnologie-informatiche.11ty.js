      ...
      <section class="container pb-5 mb-md-3 mb-lg-5">
        <div class="row align-items-center">
          <div class="col-xl-5 col-md-6 offset-xl-1 order-md-2 text-center text-md-start mb-3 mb-sm-0">
            ...
            <h1 class="mb-4">Tecnologie informatiche</h1>
            <p class="fs-xl d-md-none d-lg-block pb-2 pb-md-4 mb-lg-3">Al fianco in ogni settore, accompagniamo i nostri clienti verso l’industria 4.0 e il rinnovamento strategico del proprio business, al fine di sfruttare al meglio le potenzialità offerte dalla trasformazione digitale.</p>
            <a href="${this.i18n('pagesUrl.sectors')}" class="btn btn-primary shadow-primary btn-lg">Scopri i settori</a>
          </div>
      ...
      <section class="container pb-5 mb-md-3 mb-lg-5">
        <div class="row justify-content-center text-center">
          <div class="col-xl-6 col-lg-7 col-md-8 col-sm-10">
            ...
            <p class="text-muted mb-3 mb-lg-4">Sviluppiamo piattaforme multisettoriali per la gestione e l’integrità dei dati attraverso l’utilizzo di tecnologie Internet-of-Things (IoT) e Blockchain.</p>
          </div>
        </div>
            ...
            <div class="swiper-slide h-auto py-3">
              <div class="card border-0 shadow-sm card-hover card-hover-primary h-100 mx-2">
                <div class="card-body">
                  ...
                  <h3 class="h4">Notarizzazione dei dati</h3>
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      “Notarizzare” significa registrare digitalmente un qualsiasi documento in un registro distribuito (Blockchain) creando un file unico ed immutabile nel tempo.
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Certificazione autenticità dei dati mediante firma digitale.
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Tracciamento dei beni industriali nel modo più semplice ed efficiente. Gestione della relativa documentazione.
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Gestione, creazione di report e registri storici delle manutenzioni svolte.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="swiper-slide h-auto py-3">
              <div class="card border-0 shadow-sm card-hover card-hover-primary h-100 mx-2">
                <div class="card-body">
                  ...
                  <h3 class="h4">Gestione integrità dei dati</h3>
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Tracciamento dei beni industriali e gestione della relativa documentazione.
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Informazioni, monitoraggio e certificazioni d’uso dei beni industriali (es: ore di funzionamento, allarmi, anomalie, ecc.).
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
            ...
            <div class="swiper-slide h-auto py-3">
              <div class="card border-0 shadow-sm card-hover card-hover-primary h-100 mx-2">
                <div class="card-body">
                  ...
                  <h3 class="h4">Trasformazione digitale 4.0</h3>
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Analisi e mappatura sistema informativo e integrità dati (AS-IS).
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Sviluppo e configurazione acquisizione dati basto sul sistema Trusted IoT.
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Realizzazione piattaforme web-app per certificazione dati in Blockchain.
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      Collaudo delle soluzioni sviluppate e formazione sul loro corretto utilizzo.
                    </li>
                  </ul>
                </div>
              </div>
