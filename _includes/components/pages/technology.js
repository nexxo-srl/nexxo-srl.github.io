    ...
    return `
      ...
      <nav class="container py-4 mb-lg-2 mt-lg-3" aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center justify-content-md-start mb-0">
          ...
          <li class="breadcrumb-item active" aria-current="page">${this.i18n('pagesUrl.informationTechnology.linkName')}</li>
        </ol>
      </nav>
      ...
      <section class="container pb-5 mb-md-3 mb-lg-5">
        <div class="row align-items-center">
          <div class="col-xl-5 col-md-6 offset-xl-1 order-md-2 text-center text-md-start mb-3 mb-sm-0">
            <h2 class="h4 text-primary mb-2">${this.i18n('technology.subtitle')}</h2>
            <h1 class="mb-4">${this.i18n('technology.title')}</h1>
            <p class="fs-xl d-md-none d-lg-block pb-2 pb-md-4 mb-lg-3">${this.i18n('technology.description')}</p>
            <a href="${this.i18n('pagesUrl.sectors')}" class="btn btn-primary shadow-primary btn-lg">${this.i18n('technology.discoverMoreCTA')}</a>
          </div>
          <div class="col-md-6 order-md-1">
            ${await this.image('services/it/dashboard_TI.png', 'Tecnologie Informatiche', 'rounded-3')}
          </div>
        </div>
      </section>
      ...
      <section class="container pb-5 mb-md-3 mb-lg-5">
        <div class="row justify-content-center text-center">
          <div class="col-xl-6 col-lg-7 col-md-8 col-sm-10">
            <h2 class="h1 mb-4">${this.i18n('technology.slider.title')}</h2>
            <p class="text-muted mb-3 mb-lg-4">${this.i18n('technology.slider.description')}</p>
          </div>
        </div>
                ...
                <div class="card-body">
                  <div class="d-table position-relative p-3 mb-3">
                    ...
                    <div class="text-primary position-relative zindex-5">
                      ${await this.image('services/it/notarizzazione.png', 'Notarizzazione', 'servicesIcon', [150, 100, 50], '50w')}
                    </div>
                  </div>
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-2">
                      ...
                      ${this.i18n('technology.slider.item01.bulletPoints.item01')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item01.bulletPoints.item02')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item01.bulletPoints.item03')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item01.bulletPoints.item04')}
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="card border-0 shadow-sm card-hover card-hover-primary h-100 mx-2">
                <div class="card-body">
                  <div class="d-table position-relative p-3 mb-3">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-secondary rounded-circle"></span>
                    <div class="text-primary position-relative zindex-5">
                      ${await this.image('services/it/gestione-dati.png', 'Gestione Dati', 'servicesIcon', [150, 100, 50], '50w')}
                    </div>
                  </div>
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item02.bulletPoints.item01')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item02.bulletPoints.item02')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item02.bulletPoints.item03')}
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="card border-0 shadow-sm card-hover card-hover-primary h-100 mx-2">
                <div class="card-body">
                  <div class="d-table position-relative p-3 mb-3">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-secondary rounded-circle"></span>
                    <div class="text-primary position-relative zindex-5">
                      ${await this.image('services/it/4-0.png', 'Icona 4.0', 'servicesIcon', [150, 100, 50], '50w')}
                    </div>
                  </div>
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item03.bulletPoints.item01')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item03.bulletPoints.item02')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item03.bulletPoints.item03')}
                    </li>
                    <li class="d-flex align-items-center mb-2">
                      <i class="bx bx-check-circle fs-xl text-muted me-2"></i>
                      ${this.i18n('technology.slider.item03.bulletPoints.item04')}
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="position-relative bg-secondary rounded-3 py-5 mb-2">
          <div class="row pb-2 py-md-3 py-lg-5 px-4 px-lg-0 position-relative zindex-3">
            <div class="col-xl-3 col-lg-4 col-md-5 offset-lg-1">
              <p class="lead mb-2 mb-md-3">${this.i18n('technology.contactForm.subtitle')}</p>
              <h2 class="h1 pb-3">${this.i18n('technology.contactForm.title')}</h2>
            </div>
            <form id="contact-form" class="col-lg-6 col-md-7 offset-xl-1 needs-validation" novalidate  method="POST" action="${contactFormUrl}">
              ...
              <div class="row">
                <div class="col-sm-6 mb-4">
                  <label for="name" class="form-label fs-base">${this.i18n('technology.contactForm.fullNameField.label')}</label>
                  <input type="text" name="name" id="name" class="form-control form-control-lg" required>
                  <div class="invalid-feedback">${this.i18n('technology.contactForm.fullNameField.errorMessage')}</div>
                </div>
                <div class="col-sm-6 mb-4">
                  <label for="email" class="form-label fs-base">${this.i18n('technology.contactForm.emailField.label')}</label>
                  <input type="email" name="email" id="email" class="form-control form-control-lg" required>
                  <div class="invalid-feedback">${this.i18n('technology.contactForm.emailField.errorMessage')}</div>
                </div>
                <div class="col-12 pb-2 mb-4">
                  <label for="message" class="form-label fs-base">${this.i18n('technology.contactForm.messageField.label')}</label>
                  <textarea id="message" name="message" class="form-control form-control-lg" rows="4" required></textarea>
                  <div class="invalid-feedback">${this.i18n('technology.contactForm.messageField.errorMessage')}</div>
                </div>
              </div>
              <button type="submit" class="btn btn-primary shadow-primary btn-lg">
                <span class="spinner-border spinner-border-sm" style="display: none;" role="status" aria-hidden="true"></span>
                <span>${this.i18n('technology.contactForm.buttonCTA')}</span>
              </button>
            </form>
            <div id="contact-form-done" class="col-lg-6 col-md-7 offset-xl-1" style="display: none;">
              <h4 class="text-center">${this.i18n('technology.contactForm.thankYouMessage')}</h4>
            </div>
            ...
            <script>
                ...
                form.addEventListener('submit', (event) => {
                    ...
                    checkRecaptcha((error, token) => {
                        ...
                        const fail = () => {
                            unlockForm()
                            alert(\`${this.i18n('technology.contactForm.errorPopup.failedEmailSending')}\`)
